...
import React, { useState } from 'react'; /* STEP 0 --> import useState function */

export default function Counter() {
  /* STEP 1 */
  const [ count, setCount ] = useState(0); //create count and setCount pair and initialize count to 0
  // console.log(count)
